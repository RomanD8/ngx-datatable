...
DataTableHeaderComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  dependencies: [
    ...
    {
      kind: 'directive',
      type: i3.ResizeableDirective,
      selector: '[resizeable]',
      inputs: ['resizeEnabled', 'minWidth', 'maxWidth'],
      outputs: ['resize']
    },
    { kind: 'directive', type: i4.OrderableDirective, selector: '[orderable]', outputs: ['reorder', 'targetChanged'] },
    {
      kind: 'directive',
      type: i5.LongPressDirective,
      selector: '[long-press]',
    ...
    {
      kind: 'component',
      type: i6.DataTableHeaderCellComponent,
